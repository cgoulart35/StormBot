...
namespace StormBot.Modules
{
	public class BaseCommand : InteractiveBase<SocketCommandContext>
	{
        ...
        public async Task<bool> GetServerToggleBlackOpsColdWarTracking(StormBotContext _db)
        {
            if (!Context.IsPrivate)
            {
        ...
        public async Task<bool> GetServerToggleModernWarfareTracking(StormBotContext _db)
        {
            if (!Context.IsPrivate)
            {
                bool flag = await _db.Servers
        ...
        public async Task<bool> GetServerToggleWarzoneTracking(StormBotContext _db)
        {
            if (!Context.IsPrivate)
            {
                bool flag = await _db.Servers
        ...
        public async Task<bool> GetServerToggleSoundpadCommands(StormBotContext _db)
        {
            if (!Context.IsPrivate)
            {
                bool flag = await _db.Servers
        ...
        public async Task<bool> GetServerAllowServerPermissionBlackOpsColdWarTracking(StormBotContext _db)
        {
            if (!Context.IsPrivate)
            {
                bool flag = await _db.Servers
        ...
        public async Task<bool> GetServerAllowServerPermissionModernWarfareTracking(StormBotContext _db)
        {
            if (!Context.IsPrivate)
            {
                bool flag = await _db.Servers
        ...
        public async Task<bool> GetServerAllowServerPermissionWarzoneTracking(StormBotContext _db)
        {
            if (!Context.IsPrivate)
            {
                bool flag = await _db.Servers
        ...
        public async Task<bool> GetServerAllowServerPermissionSoundpadCommands(StormBotContext _db)
        {
            if (!Context.IsPrivate)
            {
                bool flag = await _db.Servers
